...
static void check_l() { if (s_mod_p2(s_mask5(s_hpos+1),8) < s_mod_p2(s_hpos,8)) exit(-1); }
static void check_r() { if (s_mod_p2(s_mask5(s_hpos-1),8) > s_mod_p2(s_hpos,8)) exit(-1); }
static void check_u() { if (s_mask5(s_hpos+8) < s_hpos) exit(-1); }
static void check_d() { if (s_mask5(s_hpos-8) > s_hpos) exit(-1); }
